  ...
  const handleSubmit = async (event) => {
    ...
    if (error) {
      ...
      if (user?.paymentVerified){
        axios
          .post(
            "https://food-waste-backend-production.up.railway.app/api/v1/payments/update-payment-method",
        ...
        axios
          .post(
            "https://food-waste-backend-production.up.railway.app/api/v1/payments/add-payment-method",
            {
              paymentMethodId: paymentMethod.id,
            },
            { withCredentials: true }
